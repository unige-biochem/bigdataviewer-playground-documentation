...
_bdvpg_version = "0.23.1"   # bigdataviewer-playground (sc.fiji.bdvpg.*)
_biop_bdv_tools_version  = "0.23.0"   # bigdataviewer-biop-tools  (ch.epfl.biop.*)
_bdv_image_loaders_version  = "0.23.1"   # bigdataviewer-image-loaders (ch.epfl.biop.bdv.img.*)
_bdvpg_display_version = "0.23.1"
_ijp_kheops_version = "0.23.1"
